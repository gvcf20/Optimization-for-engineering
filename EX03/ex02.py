...
def f(t, guess, T):
    ...
    p = parameters(T)  # Create an instance of the parameters class
...
def solve_ODEs(T,axial_lenght=50, plot=True):

    p = parameters(T)  # Instantiate the problem parameters
    ...
    sol = solve_ivp(f, x_span, y0, method='RK45', args=(T,), t_eval=x_eval)
